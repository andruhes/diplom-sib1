...
Можно задать вопрос на портале. В вопросе укажите открытую часть ssh-ключа (public-key). В ответе на вопрос получите адрес сервера.
Или же, написать методисту в [telegram](https://t.me/niazkashapov). Менее предпочтительный способ.
